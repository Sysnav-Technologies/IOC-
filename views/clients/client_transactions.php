...
<script type="text/javascript">
    ...
    $('#clientpay').click(function (e2) {
        ...
        $('#subloader02').load(buildUrl('clients/clientpay'), function () {
        });
    });
      ...
      $('#clientupdate').click(function (e2) {
        ...
        $('#subloader02').load(buildUrl('clients/clientupdate'), function () {
        });
    });
      ...
      $('#clienttransadd').click(function (e2) {
        ...
        $('#subloader02').load(buildUrl('clients/clientaddTransaction'), function () {
        });
    });
    ...
    $('#clienttrasactions').submit(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                console.log(data);
                $('#subloader').empty();
                $('#subloader').load(buildUrl('clients/client_transactions')).hide().fadeIn('slow');
            }
        });
            });
