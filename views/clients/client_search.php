<form class="form-horizontal">
    ...
    <fieldset>
        <div class="form-group">
            <div class="col-lg-12">
                <input type="text" class="form-control" id="search_lb" placeholder="Search Clients Here">
            </div>
        </div>
    </fieldset>
</form>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.getJSON('clients/getdatatohis', function (data) {
            ...
            var len = data.length;
            for (y = 0; y < len; y++) {
                if(data[y].trcusid == data[ee].trcuid ){
...
function myFunction() {
        ...
        $('#subloader02').load(buildUrl('clients/clientSearch'), function () {
        });
