<div class="btn-group btn-group-justified">
    ...
    <script>
        $('#fuel').click(function(){
            $('#subloader2').load(buildUrl('revenue/incomefuel'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
        $('#lubricants').click(function(){
            $('#subloader2').load(buildUrl('revenue/lubricants'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
        $('#overall').click(function(){
            $('#subloader2').load(buildUrl('revenue/incomeoverall'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        }); 
