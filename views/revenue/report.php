...
<script type="text/javascript">
    ...
    $('#expense').click(function(e2){
        e2.preventDefault();
        var id = $(this).attr('id');
        $('#subloader2').load(buildUrl('revenue/ExpensepdfReportDisplay'), function () {
            $('#subloader2').hide();
    ...
    $('#incomes').click(function(e2){
        e2.preventDefault();
        var id = $(this).attr('id');
        $('#subloader2').load(buildUrl('revenue/IncomepdfReportDisplay'), function () {
            $('#subloader2').hide();
            $('#subloader2').fadeIn('fast');
        });
    });
     ...
     $('#paymentss').click(function(e2){
        e2.preventDefault();
        var id = $(this).attr('id');
        $('#subloader2').load(buildUrl('revenue/PaypdfReportDisplay'), function () {
            $('#subloader2').hide();
            $('#subloader2').fadeIn('fast');
        });
    });
