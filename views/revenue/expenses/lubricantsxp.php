...
<div>
    ...
    <div class="col-md-12">
        <form class="form-horizontal" method="post" action="revenue/insertlubricantExp" id="lubricantexpenseForm" >
            <fieldset>
                <legend>Lubricants Expenses</legend> <!--font style-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="" id="prd-NameHidden" hidden>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="number" id="buyingQnty" name="buyingQnty" class="form-control">
                    </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#lubricant_inc_history").click(function(){
            $('#subloader2').load(buildUrl('revenue/historyLubricants'), function(){
                $('#subloader2').hide();
 ...
 //               console.log(data[a].Name);
                $("#products").append("<option value='"+ data[a].Id +" class='"+ data[a].Name +"'>" + data[a].Name + "</option>");
        ...
        $("#buyingQnty").focusout(function(){
            var qnty = $(this).val();
            var price = $("#price").val();
            var total = qnty*price;
            $("#total").val(total);
        });
        $("#lubricantexpenseForm").submit(function(e){
            e.preventDefault();
            prd = $("#products option:selected").text();
            price = $("#price").val();
            qty = $("#qty").val();
            supplier = $("#supplier").val();
            bqnty = $("#buyingQnty").val();
            total = $("#total").val();
            $.post('revenue/insertlubricantExp', { prd : prd , price : price , qty : qty , supplier : supplier , bqnty : bqnty , total : total } ,function(data){
                console.log(data);
  ...
  //               console.log(data);
  //               $('#subloader2').empty();
  //               $('#subloader2').load(buildUrl('revenue/lubricants')).hide().fadeIn('slow');
  //           }
  //       });
  //   });
  ...
  //        e2.preventDefault();
  //        var id = $(this).attr('id');
  //        $('#subloader2').load(buildUrl('revenue/' + id), function () {
