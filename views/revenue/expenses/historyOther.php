...
<table class="table table-striped table-hover ">
    <thead>
        <tr>
            <th>Description</th>
            <th>Expense (<?php echo CurrencyHelper::getSymbol(); ?>)</th>
            <th>Date</th>
            <th></th>
        </tr>
    </thead>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <form class="form-horizontal" id="history" action="transport/addBranch" method="post">
        ...
        <div class="form-group">
        <label for="address" class="col-lg-3 control-label">Payment (<?php echo CurrencyHelper::getSymbol(); ?>)</label>
        <div class="col-lg-7">
            <input type="number" class="form-control currency-input" id="edit-payment" name="address">
        </div>
        </div>
        </fieldset>
                            ...
                            if (isConfirm) {     
                                $.post('revenue/removeOtherExp', { ID : id }, function(data){
                                    ...
                                    if(data == "Success"){
                                        ...
                                        $('#subloader2').load(buildUrl('revenue/historyOther'), function(){
                                            $('#subloader2').hide();
