                ...
                function (isConfirm) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                $('#subloader2').empty();
                                $('#subloader2').load(buildUrl('revenue/lubricant_inc_history')).hide().fadeIn('slow');
            ...
            $('#form-submitted').click(function(e){
              ...
              /*  if(prd_name == ""){
                ...
                $.post('revenue/editLubinc',{ prdType : m2 , quantity : m3 , supplier : m4 , sqty : m5 , price : m6 , date : m7 , lubincome : m8 },function(data){
                    console.log(data);
                    $('#modalT').hide();
                    $('#subloader2').load(buildUrl('revenue/lubricant_inc_history'), function(){
                        $('#subloader2').hide();
...
//                    $('#subloader2').empty();
//                    $('#subloader2').load(buildUrl('revenue/income/lubricant_inc_history'), function () {
//                        $('#subloader2').hide();
//                        $('#subloader2').fadeIn('fast');
//                    });
//
