...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <fieldset>
        ...
        <div class="col-lg-7">
            <input type="number" class="form-control currency-input" id="price" placeholder="price" name="prd-price" step="0.01" min="0">
        </div>
        </div>
        <div class="form-group">
    ...
    $(document).ready(function(){
        $.getJSON('stocks/loadLubricants',function(data){
            ...
            for(x=0;x<len;x++){
                ...
                $("." + x + "").append('<td id="' + data[x].Id + "-price" + '">' + formatCurrency(data[x].Price) + '</td>');
