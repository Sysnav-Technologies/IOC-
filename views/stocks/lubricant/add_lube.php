<form class="form-horizontal" id="add_lube_form" action="stocks/addLube" method="post">
    ...
    <legend>Add new products</legend>
        ...
        <div class="form-group">
        <label for="price" class="col-lg-2 control-label">Price (<?php echo CurrencyHelper::getSymbol(); ?>)</label>
        <div class="col-lg-7">
            <input type="number" min="0" class="form-control floating-label currency-input" id="prd-price" placeholder="price" name="prd-price">
        </div>
    	</div>
        <div class="form-group">
            ...
            $.ajax({
              ...
              success: function(data){
                ...
                if(data){
                    ...
                    $('#qnty').val("");
                    $('#supplier').val("");
                    $('#subloader2').load(buildUrl('stocks/edit_lube'), function(){
                        $('#subloader2').hide();
