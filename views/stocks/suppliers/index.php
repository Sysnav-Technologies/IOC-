<div class="btn-group btn-group-justified">
	...
	<script>
        $('#search_suppliers').click(function(){
            $('#subloader2').load(buildUrl('stocks/search_suppliers'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
        $('#add_supplier').click(function(){
            $('#subloader2').load(buildUrl('stocks/add_supplier'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
        $('#edit_suppliers').click(function(){
        	$('#subloader2').load(buildUrl('stocks/edit_suppliers'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
