...
<table class="table table-striped table-hover ">
    <thead>
        <tr>
            ...
            <th>Reading</th>
            <th>Quantity(l)</th>
            <th>Order Amount (<?php echo CurrencyHelper::getSymbol(); ?>)</th>
            <th></th>
            <th></th>
        </tr>
    </thead>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <fieldset>
        ...
        <div class="form-group">
        <label for="qnty" class="col-lg-2 control-label">Order Amount (<?php echo CurrencyHelper::getSymbol(); ?>)</label>
        <div class="col-lg-7">
            
            <select id="pmp-order" class="form-control" name="prd-qnty">
                  <option value="5082">KSh 5,082</option>
                  <option value="10164">KSh 10,164</option>
                  <option value="15246">KSh 15,246</option>
            </select>
