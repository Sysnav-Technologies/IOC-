<div class="btn-group btn-group-justified">
    ...
    <script>
        $('#morning_reading').click(function(){
            $('#subloader2').load(buildUrl('stocks/morning_reading'), function(){
                $('#subloader2').hide();
        ...
        $('#evening_reading').click(function(){
            $('#subloader2').load(buildUrl('stocks/evening_reading'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
        ...
        $('#tank_stocks').click(function(){
            $('#subloader2').load(buildUrl('stocks/tank_stocks'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
