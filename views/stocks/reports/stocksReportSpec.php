...
<?php
require_once __DIR__ . '/../../../libs/SafeFPDF.php'; // Fixed: Use proper relative path
$pdf = new SafeFPDF();
...
if (!$modelStocks) {
	...
	$pdf->MultiCell(20, 20, "");
	$pdf->Text(75, 28, 'Monthly Stock report');
	...
	$heading = array("Fuel Type", "Reading", "Quantity", "Order Amount (" . CurrencyHelper::getSymbol() . ")","Date");
