<div class="btn-group btn-group-justified" id="pump-tabs">
    ...
    <script>
        $('#stockreport').click(function(){
            $('#subloader2').load(buildUrl('stocks/stockreport'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
        $('#pumpreport').click(function(){
            $('#subloader2').load(buildUrl('stocks/pumpreport'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
        $('#lubricantreport').click(function(){
            $('#subloader2').load(buildUrl('stocks/lubricantreport'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
        $('#supplierreport').click(function(){
            $('#subloader2').load(buildUrl('stocks/supplierreport'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
        $('#graphs').click(function(){
            $('#subloader2').load(buildUrl('stocks/graphs'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
