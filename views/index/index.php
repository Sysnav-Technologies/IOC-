                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo URL ?>index.php?url=stocks" class="btn btn-primary">View Stocks</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo URL ?>index.php?url=clients" class="btn btn-primary">View Clients</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo URL ?>index.php?url=employees" class="btn btn-primary">View Employees</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo URL ?>index.php?url=revenue" class="btn btn-primary">View Revenue</a>
                                </div>
                            </div>
                        </div>
                    </div>
