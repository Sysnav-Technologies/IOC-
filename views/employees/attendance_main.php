...
<script>
    ...
    $('#list').click(function () {
        $('#subloader2').load(buildUrl('employees/history_attendance'), function () {
            $('#subloader2').hide();
            $('#subloader2').fadeIn('fast');
        });
    }); 
    $('#add').click(function () {
        $('#subloader2').load(buildUrl('employees/current_attendance'), function () {
            $('#subloader2').hide();
            $('#subloader2').fadeIn('fast');
        });
    });
    ...
    $('#clicksub').submit(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                console.log(data);
                $('#subloader').empty();
                $('#subloader').load(buildUrl('employees/attendance_main')).hide().fadeIn('slow');
            }
        });
    });
</script>
