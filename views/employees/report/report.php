...
<a href="javascript:void(0)" class="btn btn-primary" id="shiftreport"><i class="mdi-action-toc"></i> Shift</a>
    ...
    <script>
        $('#attendancereport').click(function(){
            ...
            $('#subloader2').load(buildUrl('employees/attenreport'), function(){
                $('#subloader2').hide();
        ...
        $('#empreport').click(function(){
            ...
            $('#subloader2').load(buildUrl('employees/empreport'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });  
         $('#shiftreport').click(function(){
            ...
            $('#subloader2').load(buildUrl('employees/shiftreport'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        }); 
