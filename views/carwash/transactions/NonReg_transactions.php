<div class="container col-lg-6">
    <form method="post" id="transactionForm2" name="transactionForm2">
        ...
        <div class="control-group panel panel-info">
            ...
            <label class="control-label col-lg-4" style="margin-top: 10px">Amount (<?php echo CurrencyHelper::getSymbol(); ?>)</label>
            <div class="col-lg-6">
                <input type="text"  class="form-control floating-label currency-display" name="amount" id="amount" readonly="readonly" value="" style="margin-top: 10px">
            </div>
        </div>  
        <div class="control-group panel panel-info">
...
<script type="text/javascript">
    function getPackageAmount() {
        ...
        var Amount = parseFloat(PacakgeAmount);
        document.transactionForm2.amount.value = formatCurrency(Amount, false);
...
//validation
            if (cname == '' || contact == '' || email == '' || package == '' || vehicleNo == '' || date == '') {
                ...
                function (data) {
                    ...
                    $('#subloader').empty();
                    $('#subloader').load(buildUrl('carwash/nonreg_history'), function () {
                        $('#subloader').hide();
    ...
    $('#nonreg_history').click(function (e2) {
        e2.preventDefault();
        var id = $(this).attr('id');
        $('#subloader2').load(buildUrl('carwash/' + id), function () {
