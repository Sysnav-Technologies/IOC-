...
<script type="text/javascript">
    ...
    $('#Customers').click(function(e2){
        e2.preventDefault();
        var id = $(this).attr('id');
        $('#subloader2').load(buildUrl('carwash/CustomerpdfReportDisplay'), function () {
            $('#subloader2').hide();
    ...
    $('#RegpdfReport').click(function(e2){
        e2.preventDefault();
        var id = $(this).attr('id');
        $('#subloader2').load(buildUrl('carwash/RegpdfReportDisplay'), function () {
            $('#subloader2').hide();
            $('#subloader2').fadeIn('fast');
        });
    });
    ...
    $('#NonRegpdfReport').click(function(e2){
        e2.preventDefault();
        var id = $(this).attr('id');
        $('#subloader2').load(buildUrl('carwash/NonRegpdfReportDisplay'), function () {
            $('#subloader2').hide();
            $('#subloader2').fadeIn('fast');
        });
    });
