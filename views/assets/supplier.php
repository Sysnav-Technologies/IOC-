<div class="btn-group btn-group-justified">
    ...
    <script>
        $('#add_supplier').click(function(){
            $('#subloader2').load(buildUrl('assets/add_supplier'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
        $('#view_supplier').click(function(){
            $('#subloader2').load(buildUrl('assets/view_supplier'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
  $('#inform_supplier').click(function(){
            $('#subloader2').load(buildUrl('assets/inform_supplier'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
