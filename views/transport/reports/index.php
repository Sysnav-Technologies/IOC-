<div class="btn-group btn-group-justified" id="pump-tabs">
    ...
    <script>
        $('#emgreport').click(function(){
            $('#subloader2').load(buildUrl('transport/emgreport'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
        $('#lubricantreport').click(function(){
            $('#subloader2').load(buildUrl('transport/lubricantreport'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
        ...
        $('#supplierreport').click(function(){
            $('#subloader2').load(buildUrl('transport/supplierreport'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
        $('#graphs').click(function(){
            $('#subloader2').load(buildUrl('transport/graphs'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
