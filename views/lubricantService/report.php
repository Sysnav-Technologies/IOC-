...
<script type="text/javascript">
    ...
    $('#Customers').click(function(e2){
        e2.preventDefault();
        var id = $(this).attr('id');
        $('#subloader2').load(buildUrl('lube_service/CustomerpdfDisplay'), function () {
            $('#subloader2').hide();
    ...
    $('#RegpdfReport').click(function(e2){
        e2.preventDefault();
        var id = $(this).attr('id');
        $('#subloader2').load(buildUrl('lube_service/RegpdfDisplay'), function () {
            $('#subloader2').hide();
            $('#subloader2').fadeIn('fast');
        });
    });
    ...
    $('#NonRegpdfReport').click(function(e2){
        e2.preventDefault();
        var id = $(this).attr('id');
        $('#subloader2').load(buildUrl('lube_service/NonRegpdfDisplay'), function () {
            $('#subloader2').hide();
            $('#subloader2').fadeIn('fast');
        });
    });
