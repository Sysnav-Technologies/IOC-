...
<script>
        $('#lu_pac_gold').click(function(){
            $('#subloader2').load(buildUrl('lube_service/lu_pac_gold'), function(){
                $('#subloader2').hide();
        ...
        $('#lu_pac_silver').click(function(){
            $('#subloader2').load(buildUrl('lube_service/lu_pac_silver'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
//        
        ...
        $('#lu_pac_custom').click(function(){
            $('#subloader2').load(buildUrl('lube_service/lu_pac_custom'), function(){
                $('#subloader2').hide();
                $('#subloader2').fadeIn('fast');
            });
        });
    ...
    $('#EditPackageEntries').click(function (e2) {
        e2.preventDefault();
        var id = $(this).attr('id');
        $('#subloader2').load(buildUrl('lube_service/EditPackageEntries'), function () {
    ...
    $('#create_package').click(function (e2) {
        e2.preventDefault();
        var id = $(this).attr('id');
        $('#subloader2').load(buildUrl('lube_service/create_package'), function () {
